            ...
            <Card className="glass hover-lift">
              ...
              <CardContent>
                <div className="flex flex-col gap-4">
                  {[
                    { icon: Github, label: 'GitHub', handle: '@yourusername', href: '#' },
                    { icon: Linkedin, label: 'LinkedIn', handle: '/in/yourprofile', href: '#' },
                    { icon: Twitter, label: 'Twitter', handle: '@yourusername', href: '#' }
